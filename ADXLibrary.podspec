Pod::Spec.new do |s|
  ...
  s.subspec 'Base' do |base|
    ...
    base.dependency 'ADXLibrary-FBAudienceNetwork', '2.8.4.1'
    base.dependency 'ADXLibrary-Moloco', '2.8.4.1'
    base.dependency 'ADXLibrary-Tnk', '2.8.4.1'
    base.dependency 'ADXLibrary-Fyber', '2.8.4.1'
  end

  s.subspec 'Standard' do |standard|
    standard.dependency 'ADXLibrary/Base'
    standard.dependency 'ADXLibrary-Pangle', '2.8.4.1'
    standard.dependency 'ADXLibrary-UnityAds', '2.8.4.1'
  end

  s.subspec 'Native' do |native|
    native.dependency 'ADXLibrary/Core'
    native.dependency 'ADXLibrary-FBAudienceNetwork', '2.8.4.1'
    native.dependency 'ADXLibrary-Pangle', '2.8.4.1'
  end

  s.subspec 'Rewarded' do |rewarded|
    rewarded.dependency 'ADXLibrary/Base'
    rewarded.dependency 'ADXLibrary-Pangle', '2.8.4.1'
    rewarded.dependency 'ADXLibrary-UnityAds', '2.8.4.1'
  end

  s.subspec 'Lite' do |lite|
    lite.dependency 'ADXLibrary/Core'
    lite.dependency 'ADXLibrary-UnityAds', '2.8.4.1'
    lite.dependency 'ADXLibrary-Domain', '2.8.4.1'
    lite.dependency 'ADXLibrary-FBAudienceNetwork', '2.8.4.1'
  end
