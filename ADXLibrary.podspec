Pod::Spec.new do |s|
  ...
  s.subspec 'Base' do |base|
    ...
    base.dependency 'ADXLibrary-FBAudienceNetwork', '2.3.0'
    base.dependency 'ADXLibrary-Fyber', '2.3.0'
  end

  s.subspec 'Standard' do |standard|
    standard.dependency 'ADXLibrary/Base'
    standard.dependency 'ADXLibrary-Pangle', '2.3.0'
    standard.dependency 'ADXLibrary-UnityAds', '2.3.0'
