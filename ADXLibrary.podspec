Pod::Spec.new do |s|
  ...
  s.subspec 'Core' do |core|
    core.dependency 'Google-Mobile-Ads-SDK', '12.9.0'
    core.dependency 'AppLovinSDK', '13.3.1'
    core.dependency 'AdPieSDK', '1.6.10'
  ...
  s.subspec 'Base' do |base|
    ...
    base.dependency 'ADXLibrary-Tnk', '2.8.0.1'
  end
  ...
  s.subspec 'Standard' do |standard|
    ...
    standard.dependency 'ADXLibrary-Fyber', '2.8.0.1'
  end
  ...
  s.subspec 'Rewarded' do |rewarded|
    ...
    rewarded.dependency 'ADXLibrary-Fyber', '2.8.0.1'
  end
  ...
  s.subspec 'UnityPlugin' do |unityplugin|
    ...
    unityplugin.dependency 'ADXLibrary-Fyber', '2.8.0.1'
  end
