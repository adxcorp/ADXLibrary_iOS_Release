...
{
    ADXLogEvent(ADXAdNetworkAdManager, ADXAdTypeInterstitial, ADXAdEventLoad);
    ...
    [GAMInterstitialAd loadWithAdManagerAdUnitID: placementId
        ...
        if ( error )
        {
            ADXLogEventError(ADXAdNetworkAdManager, ADXAdTypeInterstitial, ADXAdEventLoadFailed, error);
...
{
    ADXLogEvent(ADXAdNetworkAdManager, ADXAdTypeInterstitial, ADXAdEventShow);
    NSString *placementId = parameters.thirdPartyAdPlacementIdentifier;
...
{
    ADXLogEvent(ADXAdNetworkAdManager, ADXAdTypeRewarded, ADXAdEventLoad);
    NSString *placementId = parameters.thirdPartyAdPlacementIdentifier;
    ...
    [GADRewardedAd loadWithAdUnitID: placementId
        ...
        if ( error )
        {
            ADXLogEventError(ADXAdNetworkAdManager, ADXAdTypeRewarded, ADXAdEventLoadFailed, error);
            MAAdapterError *adapterError = [ALGoogleAdManagerMediationAdapter toMaxError: error];
...
{
    ADXLogEvent(ADXAdNetworkAdManager, ADXAdTypeRewarded, ADXAdEventShow);
    NSString *placementId = parameters.thirdPartyAdPlacementIdentifier;
...
- (void)loadAdViewAdForParameters:(id<MAAdapterResponseParameters>)parameters
                        ...
                        andNotify:(id<MAAdViewAdapterDelegate>)delegate
{
    ADXLogEvent(ADXAdNetworkAdManager, ADXAdTypeBanner, ADXAdEventLoad);
    NSString *placementId = parameters.thirdPartyAdPlacementIdentifier;
...
{
    ADXLogEventError(ADXAdNetworkAdManager, ADXAdTypeInterstitial, ADXAdEventShowFailed, error);
...
{
    ADXLogEvent(ADXAdNetworkAdManager, ADXAdTypeInterstitial, ADXAdEventShown);
...
{
    ADXLogEvent(ADXAdNetworkAdManager, ADXAdTypeInterstitial, ADXAdEventClick);
...
{
    ADXLogEvent(ADXAdNetworkAdManager, ADXAdTypeInterstitial, ADXAdEventClose);
...
- (void)ad:(id<GADFullScreenPresentingAd>)ad didFailToPresentFullScreenContentWithError:(NSError *)error
{
    ADXLogEventError(ADXAdNetworkAdManager, ADXAdTypeRewarded, ADXAdEventShowFailed, error);
    MAAdapterError *adapterError = [MAAdapterError errorWithAdapterError: MAAdapterError.adDisplayFailedError
                                                mediatedNetworkErrorCode: error.code
                                             mediatedNetworkErrorMessage: error.localizedDescription];
...
- (void)adDidRecordImpression:(id<GADFullScreenPresentingAd>)ad
{
    ADXLogEvent(ADXAdNetworkAdManager, ADXAdTypeRewarded, ADXAdEventShown);
...
- (void)adDidRecordClick:(id<GADFullScreenPresentingAd>)ad
{
    ADXLogEvent(ADXAdNetworkAdManager, ADXAdTypeRewarded, ADXAdEventClick);
...
- (void)adDidDismissFullScreenContent:(id<GADFullScreenPresentingAd>)ad
{
    ...
    {
        ADXLogEvent(ADXAdNetworkAdManager, ADXAdTypeRewarded, ADXAdEventReward);
        MAReward *reward = [self.parentAdapter reward];
        [self.parentAdapter log: @"Rewarded user with reward: %@", reward];
        [self.delegate didRewardUserWithReward: reward];
    }
    
    ADXLogEvent(ADXAdNetworkAdManager, ADXAdTypeRewarded, ADXAdEventClose);
...
{
    ADXLogEvent(ADXAdNetworkAdManager, ADXAdTypeBanner, ADXAdEventLoaded);
...
{
    ADXLogEventError(ADXAdNetworkAdManager, ADXAdTypeBanner, ADXAdEventLoadFailed, error);
    MAAdapterError *adapterError = [ALGoogleAdManagerMediationAdapter toMaxError: error];
...
{
    ADXLogEvent(ADXAdNetworkAdManager, ADXAdTypeBanner, ADXAdEventShown);
...
{
    ADXLogEvent(ADXAdNetworkAdManager, ADXAdTypeNative, ADXAdEventLoaded);
...
{
    ADXLogEventError(ADXAdNetworkAdManager, ADXAdTypeNative, ADXAdEventLoadFailed, error);
    MAAdapterError *adapterError = [ALGoogleAdManagerMediationAdapter toMaxError: error];
...
{
    ADXLogEvent(ADXAdNetworkAdManager, ADXAdTypeNative, ADXAdEventShown);
...
{
    ADXLogEvent(ADXAdNetworkAdManager, ADXAdTypeNative, ADXAdEventClick);
