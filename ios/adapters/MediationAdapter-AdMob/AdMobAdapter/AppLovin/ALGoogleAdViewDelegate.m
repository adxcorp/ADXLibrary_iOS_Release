...
{
    ADXLogEvent(ADXAdNetworkAdMob, ADXAdTypeBanner, ADXAdEventLoaded);
...
{
    ADXLogEventError(ADXAdNetworkAdMob, ADXAdTypeBanner, ADXAdEventLoadFailed, error);
...
{
    ADXLogEvent(ADXAdNetworkAdMob, ADXAdTypeBanner, ADXAdEventShown);
...
{
    ADXLogEvent(ADXAdNetworkAdMob, ADXAdTypeBanner, ADXAdEventClick);
