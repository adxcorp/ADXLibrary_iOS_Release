...
{
    ADXLogEvent(ADXAdNetworkAdMob, ADXAdTypeInterstitial, ADXAdEventShown);
...
{
    ADXLogEvent(ADXAdNetworkAdMob, ADXAdTypeInterstitial, ADXAdEventClick);
...
{
    ADXLogEvent(ADXAdNetworkAdMob, ADXAdTypeInterstitial, ADXAdEventClose);
