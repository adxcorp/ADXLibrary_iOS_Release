...
{
    ADXLogEvent(ADXAdNetworkAdMob, ADXAdTypeInterstitial, ADXAdEventLoad);
    ...
    GADInterstitialAdLoadCompletionHandler loadHandler = ^(GADInterstitialAd *_Nullable interstitialAd, NSError *_Nullable error) {
        ...
        if ( error )
        {
            ADXLogEventError(ADXAdNetworkAdMob, ADXAdTypeInterstitial, ADXAdEventLoadFailed, error);
...
{
    ADXLogEvent(ADXAdNetworkAdMob, ADXAdTypeInterstitial, ADXAdEventShow);
    NSString *placementId = parameters.thirdPartyAdPlacementIdentifier;
...
{
    ADXLogEvent(ADXAdNetworkAdMob, ADXAdTypeRewarded, ADXAdEventLoad);
    NSString *placementId = parameters.thirdPartyAdPlacementIdentifier;
    BOOL isBiddingAd = [parameters.bidResponse al_isValidString];
    ...
    GADRewardedAdLoadCompletionHandler loadHandler = ^(GADRewardedAd *_Nullable rewardedAd, NSError *_Nullable error) {
        ...
        if ( error )
        {
            ADXLogEventError(ADXAdNetworkAdMob, ADXAdTypeRewarded, ADXAdEventLoadFailed, error);
            MAAdapterError *adapterError = [ALGoogleMediationAdapter toMaxError: error];
...
{
    ADXLogEvent(ADXAdNetworkAdMob, ADXAdTypeRewarded, ADXAdEventShow);
    NSString *placementId = parameters.thirdPartyAdPlacementIdentifier;
                        ...
                        andNotify:(id<MAAdViewAdapterDelegate>)delegate
{
    ...
    if ( isBiddingAd )
    {
        ADXLogEvent(ADXAdNetworkAdMob, ADXAdTypeBanner, ADXAdEventLoad);
    ...
    else
    {
        ...
        if ( isNative )
        {
            ADXLogEvent(ADXAdNetworkAdMob, ADXAdTypeNative, ADXAdEventLoad);
