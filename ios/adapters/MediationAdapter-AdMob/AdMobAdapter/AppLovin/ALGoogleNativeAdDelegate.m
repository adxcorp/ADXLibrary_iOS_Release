...
{
    ADXLogEvent(ADXAdNetworkAdMob, ADXAdTypeNative, ADXAdEventLoaded);
...
{
    ADXLogEventError(ADXAdNetworkAdMob, ADXAdTypeNative, ADXAdEventLoadFailed, error);
...
{
    ADXLogEvent(ADXAdNetworkAdMob, ADXAdTypeNative, ADXAdEventShown);
...
{
    ADXLogEvent(ADXAdNetworkAdMob, ADXAdTypeNative, ADXAdEventClick);
