...
{
    ADXLogEvent(ADXAdNetworkAdMob, ADXAdTypeRewarded, ADXAdEventShown);
...
{
    ADXLogEvent(ADXAdNetworkAdMob, ADXAdTypeRewarded, ADXAdEventClick);
...
- (void)adDidDismissFullScreenContent:(id<GADFullScreenPresentingAd>)ad
{
    ...
    {
        ADXLogEvent(ADXAdNetworkAdMob, ADXAdTypeRewarded, ADXAdEventReward);
        MAReward *reward = [self.parentAdapter reward];
        [self.parentAdapter log: @"Rewarded user with reward: %@", reward];
        [self.delegate didRewardUserWithReward: reward];
    }
    
    ADXLogEvent(ADXAdNetworkAdMob, ADXAdTypeRewarded, ADXAdEventClose);
