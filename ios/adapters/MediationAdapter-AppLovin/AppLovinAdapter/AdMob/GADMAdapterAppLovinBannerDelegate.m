...
- (void)adService:(nonnull ALAdService *)adService didLoadAd:(nonnull ALAd *)ad {
  ADXLogEvent(ADXAdNetworkAppLovin, ADXAdTypeBanner, ADXAdEventLoaded);
...
- (void)adService:(nonnull ALAdService *)adService didFailToLoadAdWithError:(int)code {
  ...
  ADXLogEventError(ADXAdNetworkAppLovin, ADXAdTypeBanner, ADXAdEventLoadFailed, error.description);
}

#pragma mark - Ad Display Delegate

- (void)ad:(nonnull ALAd *)ad wasDisplayedIn:(nonnull UIView *)view {
  ADXLogEvent(ADXAdNetworkAppLovin, ADXAdTypeBanner, ADXAdEventShown);
...
- (void)ad:(nonnull ALAd *)ad wasClickedIn:(nonnull UIView *)view {
  ADXLogEvent(ADXAdNetworkAppLovin, ADXAdTypeBanner, ADXAdEventClick);
