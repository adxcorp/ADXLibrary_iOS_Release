...
- (void)adService:(nonnull ALAdService *)adService didLoadAd:(nonnull ALAd *)ad {
  ADXLogEvent(ADXAdNetworkAppLovin, ADXAdTypeInterstitial, ADXAdEventLoaded);
...
- (void)adService:(nonnull ALAdService *)adService didFailToLoadAdWithError:(int)code {
  ...
  ADXLogEventError(ADXAdNetworkAppLovin, ADXAdTypeInterstitial, ADXAdEventLoadFailed, error.description);
}

#pragma mark - Ad Display Delegate

- (void)ad:(nonnull ALAd *)ad wasDisplayedIn:(nonnull UIView *)view {
  ADXLogEvent(ADXAdNetworkAppLovin, ADXAdTypeInterstitial, ADXAdEventShown);
...
- (void)ad:(nonnull ALAd *)ad wasHiddenIn:(nonnull UIView *)view {
  ADXLogEvent(ADXAdNetworkAppLovin, ADXAdTypeInterstitial, ADXAdEventClose);
...
- (void)ad:(nonnull ALAd *)ad wasClickedIn:(nonnull UIView *)view {
  ADXLogEvent(ADXAdNetworkAppLovin, ADXAdTypeInterstitial, ADXAdEventClick);
