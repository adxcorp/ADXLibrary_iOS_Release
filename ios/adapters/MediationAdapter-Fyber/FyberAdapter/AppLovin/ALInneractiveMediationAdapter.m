...
{
    ADXLogEvent(ADXAdNetworkFyber, ADXAdTypeInterstitial, ADXAdEventLoad);
...
{
    ADXLogEvent(ADXAdNetworkFyber, ADXAdTypeInterstitial, ADXAdEventShow);
...
{
    ADXLogEvent(ADXAdNetworkFyber, ADXAdTypeRewarded, ADXAdEventLoad);
...
{
    ADXLogEvent(ADXAdNetworkFyber, ADXAdTypeRewarded, ADXAdEventShow);
...
{
    ADXLogEvent(ADXAdNetworkFyber, ADXAdTypeBanner, ADXAdEventLoad);
    ...
    IAAdSpotAdResponseBlock adResponseBlock = ^(IAAdSpot *_Nullable adSpot, IAAdModel *_Nullable adModel, NSError *_Nullable error) {
        if ( !error )
        {
            ADXLogEvent(ADXAdNetworkFyber, ADXAdTypeBanner, ADXAdEventLoaded);
        ...
        {
            ADXLogEventError(ADXAdNetworkFyber, ADXAdTypeBanner, ADXAdEventLoadFailed, error);
...
{
    ADXLogEvent(ADXAdNetworkFyber, ADXAdTypeInterstitial, ADXAdEventShown);
...
{
    ADXLogEvent(ADXAdNetworkFyber, ADXAdTypeInterstitial, ADXAdEventClose);
...
- (void)IAAdWillLogImpression:(nullable IAUnitController *)unitController
{
    ADXLogEvent(ADXAdNetworkFyber, ADXAdTypeRewarded, ADXAdEventShown);
...
- (void)IAUnitControllerDidDismissFullscreen:(nullable IAUnitController *)unitController
{
    ...
    {
        ADXLogEvent(ADXAdNetworkFyber, ADXAdTypeRewarded, ADXAdEventReward);
        MAReward *reward = [self.parentAdapter reward];
        [self.parentAdapter log: @"Rewarded user with reward: %@", reward];
        [self.delegate didRewardUserWithReward: reward];
    }
    
    ADXLogEvent(ADXAdNetworkFyber, ADXAdTypeRewarded, ADXAdEventClose);
