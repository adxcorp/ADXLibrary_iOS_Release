...
#define ADAPTER_VERSION @"7.9.0.8.0"
...
{
    ADXLogEvent(ADXAdNetworkPangle, ADXAdTypeInterstitial, ADXAdEventLoad);
...
{
    ADXLogEvent(ADXAdNetworkPangle, ADXAdTypeInterstitial, ADXAdEventShow);
...
{
    ADXLogEvent(ADXAdNetworkPangle, ADXAdTypeRewarded, ADXAdEventLoad);
    NSString *slotId = parameters.thirdPartyAdPlacementIdentifier;
    NSString *bidResponse = parameters.bidResponse;
    BOOL isBidding = [bidResponse al_isValidString];
...
{
    ADXLogEvent(ADXAdNetworkPangle, ADXAdTypeRewarded, ADXAdEventShow);
...
- (void)loadAdViewAdForParameters:(id<MAAdapterResponseParameters>)parameters adFormat:(MAAdFormat *)adFormat andNotify:(id<MAAdViewAdapterDelegate>)delegate
{
    ...
    dispatchOnMainQueue(^{
        ...
        if ( isNative )
        {
            ADXLogEvent(ADXAdNetworkPangle, ADXAdTypeNative, ADXAdEventLoad);
        ...
        {
            ADXLogEvent(ADXAdNetworkPangle, ADXAdTypeBanner, ADXAdEventLoad);
...
{
    ADXLogEvent(ADXAdNetworkPangle, ADXAdTypeInterstitial, @"adDidShow");
...
{
    ADXLogEvent(ADXAdNetworkPangle, ADXAdTypeInterstitial, @"adDidClick");
...
{
    ADXLogEvent(ADXAdNetworkPangle, ADXAdTypeInterstitial, @"adDidDismiss");
...
{
    ADXLogEvent(ADXAdNetworkPangle, ADXAdTypeRewarded, @"adDidShow");
...
{
    ADXLogEvent(ADXAdNetworkPangle, ADXAdTypeRewarded, @"adDidClick");
...
{
    ADXLogEvent(ADXAdNetworkPangle, ADXAdTypeRewarded, @"userDidEarnReward");
...
{
    ADXLogEvent(ADXAdNetworkPangle, ADXAdTypeRewarded, @"userEarnRewardFailWithError");
    [self.parentAdapter log: @"Reward failed with error: %@", error];
}

- (void)adDidDismiss:(PAGRewardedAd *)ad
{
    ADXLogEvent(ADXAdNetworkPangle, ADXAdTypeRewarded, @"adDidDismiss");
...
{
    ADXLogEvent(ADXAdNetworkPangle, ADXAdTypeBanner, @"adDidShow");
...
{
    ADXLogEvent(ADXAdNetworkPangle, ADXAdTypeBanner, @"adDidClick");
...
{
    ADXLogEvent(ADXAdNetworkPangle, ADXAdTypeBanner, @"adDidDismiss");
...
{
    ADXLogEvent(ADXAdNetworkPangle, ADXAdTypeNative, @"adDidShow");
...
{
    ADXLogEvent(ADXAdNetworkPangle, ADXAdTypeNative, @"adDidClick");
...
{
    ADXLogEvent(ADXAdNetworkPangle, ADXAdTypeNative, @"adDidDismiss");
