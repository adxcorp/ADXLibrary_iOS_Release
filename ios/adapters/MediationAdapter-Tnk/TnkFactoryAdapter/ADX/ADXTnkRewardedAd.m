...
- (void)showAdFromRootViewController:(UIViewController *)rootViewController {
    if(self.adItem == nil || self.adLoaded == NO || rootViewController == nil){
        ADXLogDebug(@"Reward ad is not ready to be presented.");
        return;
    }
...
@implementation ADXTnkRewardedAd (TnkAdEvents)
...
- (void)onVideoCompletion:(id<TnkAdItem>)adItem verifyCode:(NSInteger)verifyCode {
    ADXLogDebug(@"onVideoCompletion, %ld", verifyCode);
    if(verifyCode >= 0) {
