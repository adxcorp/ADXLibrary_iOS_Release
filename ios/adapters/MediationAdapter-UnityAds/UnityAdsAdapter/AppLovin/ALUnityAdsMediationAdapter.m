...
- (void)initializeWithParameters:(id<MAAdapterInitializationParameters>)parameters completionHandler:(void (^)(MAAdapterInitializationStatus, NSString *_Nullable))completionHandler
{
    ...
    if ( [ALUnityAdsInitialized compareAndSet: NO update: YES] )
    {
        ...
        // UnityAds GDPR 관련 세팅
        [[ADXUnityAdsAdapter sharedInstance] setGDPRConsentState];
...
{
    ADXLogEvent(ADXAdNetworkUnityAds, ADXAdTypeInterstitial, ADXAdEventLoad);
...
{
    ADXLogEvent(ADXAdNetworkUnityAds, ADXAdTypeInterstitial, ADXAdEventShow);
    NSString *placementIdentifier = parameters.thirdPartyAdPlacementIdentifier;
...
{
    ADXLogEvent(ADXAdNetworkUnityAds, ADXAdTypeRewarded, ADXAdEventLoad);
    NSString *placementIdentifier = parameters.thirdPartyAdPlacementIdentifier;
...
{
    ADXLogEvent(ADXAdNetworkUnityAds, ADXAdTypeRewarded, ADXAdEventShow);
    NSString *placementIdentifier = parameters.thirdPartyAdPlacementIdentifier;
...
{
    ADXLogEvent(ADXAdNetworkUnityAds, ADXAdTypeBanner, ADXAdEventLoad);
    NSString *placementIdentifier = parameters.thirdPartyAdPlacementIdentifier;
...
{
    ADXLogEvent(ADXAdNetworkUnityAds, ADXAdTypeInterstitial, ADXAdEventLoaded);
...
{
    ADXLogEventError(ADXAdNetworkUnityAds, ADXAdTypeInterstitial, ADXAdEventLoadFailed, message);
...
{
    ADXLogEvent(ADXAdNetworkUnityAds, ADXAdTypeInterstitial, ADXAdEventShown);
...
{
    ADXLogEvent(ADXAdNetworkUnityAds, ADXAdTypeInterstitial, ADXAdEventClick);
...
{
    ADXLogEvent(ADXAdNetworkUnityAds, ADXAdTypeInterstitial, ADXAdEventClose);
...
{
    ADXLogEventError(ADXAdNetworkUnityAds, ADXAdTypeInterstitial, ADXAdEventShowFailed, message);
...
- (void)unityAdsAdLoaded:(NSString *)placementId
{
    ADXLogEvent(ADXAdNetworkUnityAds, ADXAdTypeRewarded, ADXAdEventLoaded);
...
- (void)unityAdsAdFailedToLoad:(NSString *)placementId withError:(UnityAdsLoadError)error withMessage:(NSString *)message
{
    ADXLogEventError(ADXAdNetworkUnityAds, ADXAdTypeRewarded, ADXAdEventLoadFailed, message);
...
- (void)unityAdsShowStart:(NSString *)placementId
{
    ADXLogEvent(ADXAdNetworkUnityAds, ADXAdTypeRewarded, ADXAdEventShown);
...
- (void)unityAdsShowClick:(NSString *)placementId
{
    ADXLogEvent(ADXAdNetworkUnityAds, ADXAdTypeRewarded, ADXAdEventClick);
...
- (void)unityAdsShowComplete:(NSString *)placementId withFinishState:(UnityAdsShowCompletionState)state
{
    ADXLogEvent(ADXAdNetworkUnityAds, ADXAdTypeRewarded, ADXAdEventClose);
...
- (void)unityAdsShowFailed:(NSString *)placementId withError:(UnityAdsShowError)error withMessage:(NSString *)message
{
    ADXLogEventError(ADXAdNetworkUnityAds, ADXAdTypeRewarded, ADXAdEventShowFailed, message);
